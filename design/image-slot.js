  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">o <u>elige un archivo</u></div></div>' +
        '  <div class="attr-error" part="attribution-error">' + warnIcon +
        '    <div class="cap">Esta foto necesita atribución</div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Reemplazar imagen">Reemplazar</button>' +
        '  <button data-act="edit" title="Ajustar encuadre">Ajustar</button></div>' +
    ...
    _render() {
      ...
      this._cap.textContent = this.getAttribute('placeholder') || 'Suelta una imagen';
